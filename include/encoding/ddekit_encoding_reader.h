...
struct tagDDEKIT_ENCODING_READER
{
	...
	hpint32 (*read_union_begin)(DDEKIT_ENCODING_READER *self, const char *union_name);
	hpint32 (*read_union_end)(DDEKIT_ENCODING_READER *self, const char *union_name);
	...
	hpint32 (*read_var_begin)(DDEKIT_ENCODING_READER *self, const char *var_name, hpint32 var_type);
	hpint32 (*read_var_end)(DDEKIT_ENCODING_READER *self, const char *var_name, hpint32 var_type);
