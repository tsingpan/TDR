...
HP_API hpint32 ddekit_xml_encoding_read_vector_begin(DDEKIT_ENCODING_READER *super, const char *var_name, hpint32 var_type, hpint32 end_with_zero);

HP_API hpint32 ddekit_xml_encoding_read_vector_end(DDEKIT_ENCODING_READER *super, const char *var_name, hpint32 var_type, hpint32 end_with_zero);

HP_API hpint32 ddekit_xml_encoding_read_field_begin(DDEKIT_ENCODING_READER *super, const char *var_name, hpint32 var_type);

HP_API hpint32 ddekit_xml_encoding_read_field_end(DDEKIT_ENCODING_READER *super, const char *var_name, hpint32 var_type);
