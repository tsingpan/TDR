...
static TD_ERROR_CODE _on_const(TLIBC_WRITER_HEADER_GENERATOR *self, const ST_Const *de_const)
{
...
static TD_ERROR_CODE _on_field_list(TLIBC_WRITER_HEADER_GENERATOR *self, const ST_FIELD_LIST *field_list)
{
	tuint32 i;
...
static TD_ERROR_CODE _on_union_field_list(TLIBC_WRITER_HEADER_GENERATOR *self, const ST_UNION_FIELD_LIST *union_field_list)
{
	tuint32 i;
...
static TD_ERROR_CODE _on_typedef(TLIBC_WRITER_HEADER_GENERATOR *self, const ST_TYPEDEF *de_typedef)
{
	generator_print(&self->super, "\n");
...
static TD_ERROR_CODE _on_comment(TLIBC_WRITER_HEADER_GENERATOR *self, const ST_UNIX_COMMENT *de_unix_comment)
{
