...
PHP_ADD_INCLUDE($HOTSCRIPT_DIR/include)
  ...
  PHP_ADD_LIBRARY_WITH_PATH(hotpot, $HOTSCRIPT_DIR/lib, HOTSCRIPT_SHARED_LIBADD)
  PHP_ADD_LIBRARY_WITH_PATH(hotprotocol, $HOTSCRIPT_DIR/lib, HOTSCRIPT_SHARED_LIBADD)
  PHP_ADD_LIBRARY_WITH_PATH(hoterror, $HOTSCRIPT_DIR/lib, HOTSCRIPT_SHARED_LIBADD)
